...
use \Mockery as m;
use TeamNeusta\Magedev\Docker\Image\Repository\Php5;
 ...
 */
class Php5Test extends \TeamNeusta\Magedev\Test\TestCase
{
    public function testConfigure()
    {
        ...
        $contextBuilder->shouldReceive("run")->with("apt-get install -y libfreetype6-dev libjpeg62-turbo-dev libmcrypt-dev libpng12-dev libxml2-dev");
